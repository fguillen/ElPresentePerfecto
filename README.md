...
Replace `<ProjectName>` with yout project name:
    ...
    curl -#L https://raw.github.com/fguillen/ElPresentePerfecto/master/etc/osx_init.rb | PROJECT_NAME=<ProjectName> ruby
    cd <ProjectName>
...
* Add ElPresentePerfecto_session to be replaced in the init script
