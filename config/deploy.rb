...
set :application, "el_presente_perfecto"
set :scm, :git
set :repository,  "git@github.com:fguillen/ElPresentePerfecto.git"
set :branch, "master"
set :deploy_to, "/home/www/el_presente_perfecto.fernandoguillen.info"
set :user, "fguillen"
set :group, "fguillen"
set :use_sudo, false

server "el_presente_perfecto.fernandoguillen.info", :web, :app, :db, :primary => true
